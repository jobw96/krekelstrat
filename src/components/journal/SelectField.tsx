  ...
  return (
    <div ref={ref} className={`relative ${className}`}>
      ...
      {open && (
        <div
          role="listbox"
          className="absolute left-0 right-0 top-[calc(100%+6px)] z-50 flex max-h-64 flex-col gap-0.5 overflow-y-auto rounded-control border border-white/10 p-1.5 shadow-2xl"
